...
User.sync({force: true})
  .then(() => {
    ...
    User.bulkCreate([
      {firstname: 'bryan', email: 'asdf1@gmail.com', profilepic: 'https://s-media-cache-ak0.pinimg.com/736x/f1/e0/f8/f1e0f89ea5d4275714a7af7c8f15c861--latina-girls-piano-bar.jpg', images: [], bio: 'I am a big dummy user', gender: 'male', age: 22, latitude: 38, longitude: -122},
