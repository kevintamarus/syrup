...
User.sync({force: true})
  .then(() => {
    ...
    User.bulkCreate([
      {firstname: 'bryan', email: 'asdf1@gmail.com', profilepic: 'https://images.pexels.com/photos/91227/pexels-photo-91227.jpeg?h=350&auto=compress&cs=tinysrgb', images: [], bio: 'I am a big dummy user', gender: 'male', age: 22, latitude: 38, longitude: -122},
